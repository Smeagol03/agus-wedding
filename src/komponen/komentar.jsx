...
const Komentar = () => {
  ...
  const handleDeleteComment = async (commentId) => {
    ...
    try {
      ...
      const commentRef = ref(database, `komentar_agus/${commentId}`);
  ...
  useEffect(() => {
    ...
    const commentsRef = ref(database, "komentar_agus");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (lastSubmitTime && now - parseInt(lastSubmitTime) < 10000) {
        throw new Error("Mohon tunggu 10 detik sebelum mengirim komentar lagi");
      }
