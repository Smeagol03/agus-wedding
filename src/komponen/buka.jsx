  ...
  return (
    <>
      ...
      <div className="absolute inset-0 flex gap-2 sm:gap-5 md:gap-[20px] flex-col content-center items-center justify-end z-10 text-white pb-14 md:pb-16 px-4 sm:px-6 md:px-8">
        ...
        <RotatingText
          texts={["Agus Putra", "&", "Mardiana Rosita S.pd", "&"]}
          mainClassName="text-md md:text-4xl text-white font-head overflow-hidden justify-center"
          staggerFrom={"last"}
          initial={{ y: "100%" }}
          animate={{ y: 0 }}
          exit={{ y: "-100%" }}
